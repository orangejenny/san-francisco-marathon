...
public class sketch_feb19a extends PApplet {
...
/* Global data */
float[] sundays = {8, 10, 6, 12, 14, 8, 16, 18, 10, 20, 8, 20, 12, 20, 12, 10, 8, 26.2f};
...
public void setup() {
  ...
  float mile_width = body_width / 26.2f;
  ...
  drawCircle(13.1f, origin);
  drawCircle(26.2f, origin);
...
public void drawCircle(float mile_mark, Point o) {
    float x = o.x + mile_mark * (body_width / 26.2f);
    float y = height / 2;
    int radius = 15;
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "sketch_feb19a" });
  }
}
